...
let testjyiArticleContent: jyiArticleContent[] = [
  {langCode: 'en', title: 'Nanoparticles: the Future of Drug Delivery', date: 'January 1, 2020', authors: ['Syed Haider'], 
    body: '<p>Drug development is one of the largest industries in the world. A significant amount of resources and time is invested into to produce drugs for clinical use. Equally important is the process of drug delivery and targeting by which the synthesized compounds are delivered to tissues in the body. As reported by Transparency Market Research in 2018, the drug delivery market is rapidly rising and is expected to be worth US $900 billion by 2025.</p>'}, 
